...
urlpatterns = patterns('',
    ...
    (r'^data/view/(?P<slug_or_id>[A-Za-z0-9-_]+)/$', views.data_view_main),
    (r'^data/view/main/(?P<slug_or_id>[A-Za-z0-9-_]+)/$', views.data_view_main),
    (r'^data/view/data/(?P<slug_or_id>[A-Za-z0-9-_]+)/$', views.data_view_data),
    (r'^data/view/other/(?P<slug_or_id>[A-Za-z0-9-_]+)/$', views.data_view_other),
