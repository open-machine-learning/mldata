...
urlpatterns = patterns('',
    ...
    url(r'^new_from_data/(?P<cur_data>[A-Za-z0-9-_]+)/$', views.task.new, name='task_new_from_data'),
    ...
    url(r'^rate/(?P<id>\d+)/$', views.task.rate, name='task_rate'),
    ...
    url(r'^download/rdata/([A-Za-z0-9-_]+)/$', views.task.download_rdata, name='task_download_rdata'),
