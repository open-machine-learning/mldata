...
urlpatterns = patterns('',
    ...
    (r'^data/download/(?P<slug>[A-Za-z0-9-_]+)/$', views.data_download),
    (r'^data/download/xml/(?P<slug>[A-Za-z0-9-_]+)/$', views.data_download_xml),
    (r'^data/download/csv/(?P<slug>[A-Za-z0-9-_]+)/$', views.data_download_csv),
    (r'^data/download/arff/(?P<slug>[A-Za-z0-9-_]+)/$', views.data_download_arff),
    (r'^data/download/libsvm/(?P<slug>[A-Za-z0-9-_]+)/$', views.data_download_libsvm),
    (r'^data/download/matlab/(?P<slug>[A-Za-z0-9-_]+)/$', views.data_download_matlab),
    (r'^data/download/octave/(?P<slug>[A-Za-z0-9-_]+)/$', views.data_download_octave),
